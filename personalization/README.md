...
This use case tutorial shows how to personalize user experiences for new andreturning users using Fingerprint.
...
To clear personalization data and reset the demo database:
